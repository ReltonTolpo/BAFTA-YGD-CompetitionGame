...
function update(dt)
 shipalpha=player.shipalpha 
	...
	if player.onPlanet == true then
		...
		if love.keyboard.isDown('e') and player.x < 400 and player.x > 100 and player.y > 400 and shipActive == false and player.dead == false and tutorial.counter > 5000 then
