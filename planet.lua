...
function planet.load()
	...
	planetArray = {{}}
	planetArray[1] = {love.math.random(0, 255), love.math.random(0, 255), love.math.random(0, 255), love.math.random(2, 5), love.math.random(0.01, 0.1)}-- Planet R, Planet G, Planet B, gravity, orbitTime

	for i = 1, 3 do--> planet.planetNum do (doesn't work)
		planetArray[#planetArray + 1] = {love.math.random(0, 255), love.math.random(0, 255), love.math.random(0, 255), love.math.random(2, 5), love.math.random(0.01, 0.1)}
	end
